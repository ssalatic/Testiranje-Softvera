        ...
        <div class="col-sm-4">
			...
			<div id="myTabContent" class="tab-content">
				<div class="tab-pane fade active in" id="know">
					...
					<form id="registrationForm" method="POST" class="form-horizontal" action="{{ URL::route('removeFromCanWear') }}">
				...
				<div class="tab-pane fade" id="other">
					<form role="search">
					 ...
					 <form id="registrationForm" method="POST" class="form-horizontal" action="{{ URL::route('addToCanWear') }}"> 
