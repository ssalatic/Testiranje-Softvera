    ...
    <div class="row">
		...
		<div class="col-sm-5">
			<table class="user-info hidden-xs">
				<tr>
					<td>Date:</td><td><span id="p_date"> 
					<?php // TrainingModel::getVisibleTrainings(); 
							echo (new DateTime($tr->date))->format('d F y'); ?></span></td>
                </tr>
				<tr>
					<td>Time:</td><td><span id="p_date"><?php  echo(new DateTime($tr->duration))->format('H:i'); ?></span></td>
                </tr>
				<tr>
					<td>Teacher:</td><td><span id="teacher">
					<?php 
						$teacher = $tr->trainer()->getResults();
                ...
                <?php
					if($tr->group_id != null){
						$group =  $tr->group()->getResults(); 
						echo '<tr>
							<td>Group:</td><td><span id="group">'.$group->name.'</span></td>
							</tr>';
					}
			...
			<table class="table table-striped table-hover ">
				...
				<?php 
					if($tr->group_id != null){
						$users = $tr->group()->getResults()->users()->getResults();
